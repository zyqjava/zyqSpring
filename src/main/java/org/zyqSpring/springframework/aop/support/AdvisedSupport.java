package org.zyqSpring.springframework.aop.support;

import org.zyqSpring.springframework.aop.aspect.AfterReturningAdviceInterceptor;
import org.zyqSpring.springframework.aop.aspect.AfterThrowingAdviceInterceptor;
import org.zyqSpring.springframework.aop.aspect.MethodBeforeAdviceInterceptor;
...
public class AdvisedSupport {
    ...
    private void parse() {
        ...
        String pointCut = aopConfig.getPointCut()
                ...
                .replaceAll("\\(", "\\\\(")
                .replaceAll("\\)", "\\\\)");
        //pointCut=public .* com.zyq.demo.service..*Service..*(.*)
